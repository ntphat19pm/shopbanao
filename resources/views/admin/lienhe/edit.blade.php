            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <div class="form-group invalid">
                  ...
                  <textarea type="text" style="resize: none" rows="5" class="form-control" name="zalo" id="zalo" required >{{$data->zalo}}</textarea>
                </div>
              ...
              <div class="col-lg-8">
                ...
                <div class="form-group invalid">
                    ...
                    <textarea type="text" style="resize: none" rows="9" class="form-control" name="fanpage" id="fanpage" required >{{$data->fanpage}}</textarea>
                </div>

                <div class="form-group invalid">
                  <label for="mess" class="form-label">Messager Facebook</label>
                  <textarea type="text" style="resize: none" rows="23" class="form-control" name="mess" id="mess" required >{{$data->mess}}</textarea>
                </div>
